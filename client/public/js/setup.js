...
// window.addEventListener("keypress", pressSpace, false);
// function pressSpace(key){
//   if (key.keyCode == 32) {
//     if (stepCount !=4){
...
//           var user0 = document.getElementById('player0').value;
//
//           savePlayer(0, user0);
//
//           currentScreen++;
...
// window.addEventListener("keypress", function Carpenter(key){
//   if (key.keyCode === 50) {
//     window.location.href = "/mainmenu";
//     window.addEventListener("keypress", function Farmer(key){
//   if (key.keyCode === 51) {
//     window.location.href = "/mainmenu";
//
